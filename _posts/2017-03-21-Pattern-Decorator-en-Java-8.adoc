...
Lors de l'appel à la méthode "with", le traitement est lazy, non évalué et non executé (lazy evaluation). Ceci est rendu possible par l'intermédiaire de la fonction.
